...
class Logger:
    ...
    def log(self, agent: str, event: str, data: Dict[str, Any],
            level: str = 'INFO', error: Optional[Exception] = None):
        ...
        elif event in ['complete', 'analysis_complete'] and event_key in self.event_start_times:
    ...
    def _format_data_summary(self, data: Dict[str, Any]) -> str:
        ...
        highlight_fields = [
            'subtasks', 'hypotheses', 'validated', 'total',
        ...
        return ", ".join(summary_parts) if summary_parts else json.dumps(data, indent=None)

    def log_metric(self, agent: str, metric_name: str, metric_value: Any,
